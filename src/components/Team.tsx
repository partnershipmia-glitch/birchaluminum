    ...
    <section id="team" className="section-padding bg-secondary">
      <div className="container mx-auto px-5 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            <p className="text-minimal text-brand mb-3">On the ground</p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border border-border bg-background px-5 py-2.5 text-sm font-bold hover:bg-muted transition-colors"
            >
              View on Instagram
            </a>
          </div>
